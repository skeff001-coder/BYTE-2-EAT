  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <header className="flex items-center justify-between px-5 pt-6 pb-4">
        ...
        <button
          onClick={() => !canScan && (setPaywallVariant("default"), setShowPaywall(true))}
      ...
      {stage === "result" && result && (
        <div className="px-5 pb-10">
          ...
          {credits === 1 && hasExpiry && (
            <button
              onClick={() => { setPaywallVariant("default"); setShowPaywall(true); }}
          ...
          {!canScan && (
            <button onClick={() => { setPaywallVariant("default"); setShowPaywall(true); }} className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl py-4 text-sm font-semibold text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
